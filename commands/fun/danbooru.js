...
module.exports = {
    ...
    run: async (client, message, args) => {
      ...
      var url = ""
      if(message.channel.nsfw != true) {
        url = "https://danbooru.donmai.us/posts.json?tags=" + args.slice(1,2).join("+") + "&limit=" + args[0] + "&random=true" + "&rating=s" + "&api_key=o7YZcCmpiHPZXY6Nm8TDxhjZ&login=Coder_Tavi"
      } else {
        url = "https://danbooru.donmai.us/posts.json?tags=" + args.slice(1,2).join("+") + "&limit=" + args[0] + "&random=true" + "&api_key=o7YZcCmpiHPZXY6Nm8TDxhjZ&login=Coder_Tavi"
      }
