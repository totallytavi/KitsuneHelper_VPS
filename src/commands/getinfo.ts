    ...
    .addSubcommand((subcommand) => {
      return subcommand
        ...
        .addChannelOption((option) => {
          return option.setName('channel').setDescription('The channel to get information about').setRequired(true);
        });
    })
    .addSubcommand((subcommand) => {
      return subcommand
        ...
        .addRoleOption((option) => {
          return option.setName('role').setDescription('The role to get information about').setRequired(true);
        });
    })
    .addSubcommand((subcommand) => {
      return subcommand
        ...
        .addUserOption((option) => {
          return option.setName('magician').setDescription('The magician to get permissions from').setRequired(true);
        })
        .addChannelOption((option) => {
          return option
            .setName('channel')
            .setDescription(
              "The channel to get permissions from (This will show magician's permissions in the channel)"
            )
            .setRequired(false);
        });
    }),
