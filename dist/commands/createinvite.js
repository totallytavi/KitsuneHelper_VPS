...
const { Client, CommandInteraction, CommandInteractionOptionResolver, PermissionFlagsBits, SlashCommandBuilder } = require("discord.js");
...
module.exports = {
    ...
    run: async (client, interaction, options) => {
        ...
        if (!interaction.guild.me.permissionsIn(channel).has(PermissionFlagsBits.CreateInstantInvite))
