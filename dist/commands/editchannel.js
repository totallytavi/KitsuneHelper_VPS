...
module.exports = {
    ...
    run: async (client, interaction, options) => {
        ...
        if (!interaction.guild.me.permissionsIn(channel).has("MANAGE_CHANNELS"))
        ...
        if (options._hoistedOptions[1].name === "name") {
            ...
            if (!channel.isText())
                return interactionEmbed(3, "[ERR-ARGS]", "Arg: channel :-: Expected TextBasedChannel, got Category/VoiceBasedChannel", interaction, client, true);
            ...
            if (!channel.isVoice())
                return interactionEmbed(3, "[ERR-ARGS]", "Arg: channel :-: Expected VoiceBasedChannel, got TextBasedChannel", interaction, client, true);
